...
//    return Observable.rangeLong(0, seconds).map { seconds - it }.delay(1, TimeUnit.SECONDS)
    return Observable.intervalRange(0, seconds+1, 0, 1, TimeUnit.SECONDS).map { seconds - it }
  }
}
