...
object Riddle10 {
    ...
    fun solve(first: Observable<Int>, function: (Int) -> Observable<String>): Observable<Pair<Int, String>> =
            first
                    .flatMap({ function(it) }) { firstItem, functionItem ->
                        firstItem to functionItem
                    }

    /**
     * Alternative solution
     */
    fun solve2(first: Observable<Int>, function: (Int) -> Observable<String>): Observable<Pair<Int, String>> =
